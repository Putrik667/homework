...
// СОЗДАЁМ ЭКЗЕМПЛЯР МОДАЛКИ (добавьте нужные классы)
new Modal({
   MODAL_WRAPPER: "modal",               // класс обёртки всей модалки
   PAGE_BODY: "page",                    // класс элемента, у которого блокируем скролл (например, body class="page")
   PAGE_BODY_NO_SCROLL: "no-scroll"      // класс, который добавляется для запрета скролла
});